...
Properties { 
	...
	_BaseColor ("Base color", COLOR)  = ( .24, .65, .69, 0.5) 
	_SpecColor ("Specular Material Color", Color) = (0.5,0.5,0.5,1) 
    _Shininess ("Shininess", Float) = 5
	_ShoreTex ("Shore & Foam texture ", 2D) = "black" {} 
	 
	_InvFadeParemeter ("Auto blend parameter (Edge, Shore, Distance scale)", Vector) = (0.1 ,0.29, 0.5, 1.0)
